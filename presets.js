...
export const savedPoses = [
  { 
    ...
    refImage: "data:image/png;base64,iVBORw0KGgoAAA..." // Paste your base64 text string for image 1 inside these quotes
  },
  { 
    id: 2, 
    ...
    refImage: "data:image/png;base64,R0lGODlhAQABA..." // Paste your base64 text string for image 2 inside these quotes
  },
  { 
    id: 3, 
    ...
    refImage: "data:image/png;base64,iVBORw0KGgoAAA..." // Paste your base64 text string for image 3 inside these quotes
  },
  { 
    id: 4, 
    ...
    refImage: "data:image/png;base64,iVBORw0KGgoAAA..." // Paste your base64 text string for image 4 inside these quotes
  },
  { 
    id: 5, 
    ...
    refImage: "data:image/png;base64,iVBORw0KGgoAAA..." // Paste your base64 text string for image 5 inside these quotes
  },
  { 
    id: 6, 
    ...
    refImage: "data:image/png;base64,iVBORw0KGgoAAA..." // Paste your base64 text string for image 6 inside these quotes
  },
  { 
    id: 7, 
    ...
    refImage: "data:image/png;base64,iVBORw0KGgoAAA..." // Paste your base64 text string for image 7 inside these quotes
  }
];
